...
const buttonSelector =
  "section#region-main aside#block-region-content section.block_timeline div[data-region='event-list-content'] button[data-action='more-events']";
...
function clickMoreShowButton(button) {
  ...
  button.click();
  console.log(
    "タイムラインの「さらに活動を表示する」ボタンをクリックしました。",
  );
}
