...
function createListOparateButton() {
  ...
  const parentElement = document.querySelector(
    "nav.navbar div.primary-navigation ul[role='menubar']",
  );
  ...
  listOparateButton.addEventListener("click", (e) => {
    appearedOparatePopup();
  }); //クリック時にコンフィグ要素を出現
...
async function createPopupOperateFeatures() {
  ...
  features.forEach((featureJson) => {
    ...
    toggle.addEventListener("click", (e) => {
      chrome.storage.sync.set({
        ["toggle_" + e.target.dataset.featureKey]: e.target.checked,
      });
    });
  ...
  githubLink.href =
    "https://github.com/harunn416/Kyutech_moodle_chrome_extentions";
  ...
  extensionLink.href =
    "https://chromewebstore.google.com/detail/%E4%B9%9D%E5%B7%A5%E5%A4%A7moodle%E4%BE%BF%E5%88%A9%E3%83%84%E3%83%BC%E3%83%AB/hhbkgambgapnagjlbgmcaebcndlodlje?authuser=0&hl=ja";
